...
pub mod math_utils {
	...
	#[inline(always)]
	#[must_use]
	pub fn as_real<T: ComplexField>(value: &T) -> T {
		T::from_real_impl(&T::real_part_impl((value).by_ref()))
	}
	#[inline(always)]
	#[must_use]
...
fn abs_impl<T: RealField>(re: T, im: T) -> T {
	...
	if re_abs > big || im_abs > big {
		((re * small).abs2() + (im * small).abs2()).sqrt() * big
	} else if re_abs > one || im_abs > one {
		(re.abs2() + im.abs2()).sqrt()
	} else {
		((re * big).abs2() + (im * big).abs2()).sqrt() * small
	}
}
...
fn sqrt_impl<T: RealField>(re: T, im: T) -> (T, T) {
	...
	let out_re = sum.mul_pow2(half).sqrt();
	let mut out_im = (abs - re).mul_pow2(half).fmax(zero).sqrt();
	if im_negative {
		out_im = -out_im;
	}
	(out_re, out_im)
...
impl<T: ComplexField, S: Simd> Copy for SimdCtx<T, S> {}
impl<T: ComplexField, S: Simd> Clone for SimdCtx<T, S> {
	#[inline]
	fn clone(&self) -> Self {
		*self
	}
...
impl<T: ComplexField, S: Simd> SimdCtx<T, S> {
	...
	#[inline(always)]
	pub fn splat(&self, value: impl ByRef<T>) -> T::SimdVec<S> {
		unsafe {
			core::mem::transmute_copy(&T::simd_splat(&self.0, value.by_ref()))
		}
	}
	...
	pub fn splat_real(
		&self,
		value: impl ByRef<T::Real>,
	) -> RealReg<T::SimdVec<S>> {
		RealReg(unsafe {
			core::mem::transmute_copy(&T::simd_splat_real(
				&self.0,
				value.by_ref(),
			))
		})
	...
	pub fn abs1(&self, value: T::SimdVec<S>) -> RealReg<T::SimdVec<S>> {
		let value = unsafe { core::mem::transmute_copy(&value) };
		RealReg(unsafe {
			core::mem::transmute_copy(&T::simd_abs1(&self.0, value))
		})
	}
	...
	pub fn abs_max(&self, value: T::SimdVec<S>) -> RealReg<T::SimdVec<S>> {
		let value = unsafe { core::mem::transmute_copy(&value) };
		RealReg(unsafe {
			core::mem::transmute_copy(&T::simd_abs_max(&self.0, value))
		})
	}
	...
	pub fn mul_real(
		...
		let rhs = unsafe { core::mem::transmute_copy(&rhs) };
		unsafe {
			core::mem::transmute_copy(&T::simd_mul_real(&self.0, lhs, rhs))
		}
	}
	...
	pub fn mul_pow2(
		...
		let rhs = unsafe { core::mem::transmute_copy(&rhs) };
		unsafe {
			core::mem::transmute_copy(&T::simd_mul_pow2(&self.0, lhs, rhs))
		}
	}
	...
	pub fn conj_mul(
		...
		let rhs = unsafe { core::mem::transmute_copy(&rhs) };
		unsafe {
			core::mem::transmute_copy(&T::simd_conj_mul(&self.0, lhs, rhs))
		}
	}
	...
	pub fn mul_add(
		...
		unsafe {
			core::mem::transmute_copy(&T::simd_mul_add(&self.0, lhs, rhs, acc))
		}
	}
	...
	pub fn conj_mul_add(
		...
		let acc = unsafe { core::mem::transmute_copy(&acc) };
		unsafe {
			core::mem::transmute_copy(&T::simd_conj_mul_add(
				&self.0, lhs, rhs, acc,
			))
		}
	}
	...
	#[inline(always)]
	pub fn maybe_conj_mul_add<const CONJ: bool>(
		&self,
		lhs: T::SimdVec<S>,
		rhs: T::SimdVec<S>,
		acc: T::SimdVec<S>,
	...
	pub fn abs2(&self, value: T::SimdVec<S>) -> RealReg<T::SimdVec<S>> {
		let value = unsafe { core::mem::transmute_copy(&value) };
		RealReg(unsafe {
			core::mem::transmute_copy(&T::simd_abs2(&self.0, value))
		})
	}
	...
	pub fn abs2_add(
		...
		let acc = unsafe { core::mem::transmute_copy(&acc) };
		RealReg(unsafe {
			core::mem::transmute_copy(&T::simd_abs2_add(&self.0, value, acc))
		})
	}
	...
	pub fn reduce_sum(&self, value: T::SimdVec<S>) -> T {
		let value = unsafe { core::mem::transmute_copy(&value) };
		unsafe {
			core::mem::transmute_copy(&T::simd_reduce_sum(&self.0, value))
		}
	}
	...
	pub fn reduce_max(&self, value: RealReg<T::SimdVec<S>>) -> T {
		let value = unsafe { core::mem::transmute_copy(&value) };
		unsafe {
			core::mem::transmute_copy(&T::simd_reduce_max(&self.0, value))
		}
	}
	...
	pub fn lt(
		...
		let rhs = unsafe { core::mem::transmute_copy(&rhs) };
		unsafe {
			core::mem::transmute_copy(&T::simd_less_than(&self.0, lhs, rhs))
		}
	}
	...
	pub fn gt(
		...
		let rhs = unsafe { core::mem::transmute_copy(&rhs) };
		unsafe {
			core::mem::transmute_copy(&T::simd_greater_than(&self.0, lhs, rhs))
		}
	}
	...
	pub fn le(
		...
		let rhs = unsafe { core::mem::transmute_copy(&rhs) };
		unsafe {
			core::mem::transmute_copy(&T::simd_less_than_or_equal(
				&self.0, lhs, rhs,
			))
		}
	}
	...
	pub fn ge(
		...
		let rhs = unsafe { core::mem::transmute_copy(&rhs) };
		unsafe {
			core::mem::transmute_copy(&T::simd_greater_than_or_equal(
				&self.0, lhs, rhs,
			))
		}
	}
	...
	pub fn select(
		...
		let rhs = unsafe { core::mem::transmute_copy(&rhs) };
		unsafe {
			core::mem::transmute_copy(&T::simd_select(&self.0, mask, lhs, rhs))
		}
	}
	...
	pub fn iselect(
		...
		unsafe {
			core::mem::transmute_copy(&T::simd_index_select(
				&self.0, mask, lhs, rhs,
			))
		}
	}
	...
	pub fn isplat(&self, value: T::Index) -> T::SimdIndex<S> {
		unsafe {
			core::mem::transmute_copy(&T::simd_index_splat(&self.0, value))
		}
	}
	...
	pub fn iadd(
		...
		unsafe {
			core::mem::transmute_copy(&T::simd_index_add(&self.0, lhs, rhs))
		}
	}
	...
	pub fn store(&self, ptr: &mut T::SimdVec<S>, value: T::SimdVec<S>) {
		let value = unsafe { core::mem::transmute_copy(&value) };
		unsafe {
			core::mem::transmute_copy(&T::simd_store(&self.0, ptr, value))
		}
	}
}
pub unsafe trait Conjugate:
	Send + Sync + core::fmt::Debug + Imply<Self::Canonical, Is: RefOps>
{
...
pub trait Index: IndexCore {
	...
	#[inline]
	fn sum_nonnegative(slice: &[Self]) -> Option<Self> {
		Self::Signed::sum_nonnegative(bytemuck::cast_slice(slice))
			.map(Self::from_signed)
	}
}
...
where
	T: core::ops::Neg<Output = Self>
		...
		+ core::ops::MulAssign
		+ core::ops::DivAssign
		+ for<'a> core::ops::Add<&'a T, Output = Self>
		+ for<'a> core::ops::Sub<&'a T, Output = Self>
		+ for<'a> core::ops::Mul<&'a T, Output = Self>
		+ for<'a> core::ops::Div<&'a T, Output = Self>
		+ for<'a> core::ops::AddAssign<&'a T>
		+ for<'a> core::ops::SubAssign<&'a T>
		+ for<'a> core::ops::MulAssign<&'a T>
	...
	+ Imply<Self::Real, Is: RefOps>
{
	...
	unsafe fn simd_mask_store<S: Simd>(
		...
		let simd = Self::ctx_from_simd(ctx);
		if const { Self::Unit::IS_NATIVE_F32 } {
			Self::simd_mask_store_raw(
				ctx,
				mask,
				ptr,
				simd.interleave_shfl_f32s(value),
			)
		} else if const { Self::Unit::IS_NATIVE_F64 } {
			Self::simd_mask_store_raw(
				ctx,
				mask,
				ptr,
				simd.interleave_shfl_f64s(value),
			)
		} else {
			panic!();
		}
		...
		unsafe {
			if const { Self::Unit::IS_NATIVE_F32 } {
				core::mem::transmute_copy::<_, Self::SimdIndex<S>>(
					&simd.deinterleave_shfl_f32s(Interleave(
						core::mem::transmute_copy::<_, Self::SimdVec<S>>(
							&pulp::iota_32::<Interleave<Self>, 64>(),
						),
					)),
				)
			} else if const { Self::Unit::IS_NATIVE_F64 } {
				core::mem::transmute_copy::<_, Self::SimdIndex<S>>(
					&simd.deinterleave_shfl_f64s(core::mem::transmute_copy::<
						_,
						Self::SimdVec<S>,
					>(&pulp::iota_64::<
						Interleave<Self>,
...
impl RealField for f32 {
	...
	#[inline(always)]
	fn sqrt_min_positive_impl() -> Self {
		Self::sqrt_impl(&Self::MIN_POSITIVE)
	}

	#[inline(always)]
	fn sqrt_max_positive_impl() -> Self {
		Self::sqrt_impl(&Self::MIN_POSITIVE.recip())
	}
...
impl<T: RealField<Unit: ComplexField>> ComplexField for Complex<T> {
	...
	fn abs1_impl(value: &Self) -> Self::Real {
		use crate::ext::*;
		value.re.abs1() + value.im.abs1()
	}

	#[inline]
	fn abs2_impl(value: &Self) -> Self::Real {
		use crate::ext::*;
		value.re.abs2() + value.im.abs2()
	}
	...
	fn mul_pow2_impl(lhs: &Self, rhs: &Self::Real) -> Self {
		use crate::ext::*;
		Complex {
			re: lhs.re.mul_pow2(rhs),
			im: lhs.im.mul_pow2(rhs),
		}
	}
	...
	fn simd_abs2_add<S: Simd>(
		...
		let v = T::simd_abs2_add(
			ctx,
			value.re,
			T::simd_abs2_add(ctx, value.im, acc.re),
		);
		Complex { re: v, im: v }
	}
	...
	fn simd_mem_mask_between<S: Simd>(
		...
		let n = core::mem::size_of::<Self::SimdVec<S>>()
		...
		let re = T::simd_mem_mask_between(
			ctx,
			T::Index::truncate(sa),
			T::Index::truncate(ea),
		);
		let im = T::simd_mem_mask_between(
			ctx,
			T::Index::truncate(sb),
			T::Index::truncate(eb),
		);
	...
	unsafe fn simd_mask_load_raw<S: Simd>(
		...
		Complex {
			re: T::simd_mask_load_raw(
				ctx,
				mask.re,
				core::ptr::addr_of!((*ptr).re),
			),
			im: T::simd_mask_load_raw(
				ctx,
				mask.im,
				core::ptr::addr_of!((*ptr).im),
			),
		}
	}
	...
	unsafe fn simd_mask_store_raw<S: Simd>(
		...
		T::simd_mask_store_raw(
			ctx,
			mask.re,
			core::ptr::addr_of_mut!((*ptr).re),
			values.re,
		);
		T::simd_mask_store_raw(
			ctx,
			mask.im,
			core::ptr::addr_of_mut!((*ptr).im),
			values.im,
		);
	}
}
...
impl_op!({
	impl<T: RealField> Add for ComplexImpl<T> {
		fn add(self, rhs: Self) -> Self::Output {
			use math_utils::*;
			ComplexImpl(add(&self.0, &rhs.0))
		}
	}
	impl<T: RealField> Sub for ComplexImpl<T> {
		fn sub(self, rhs: Self) -> Self::Output {
			use math_utils::*;
			ComplexImpl(sub(&self.0, &rhs.0))
		}
	}
	impl<T: RealField> Mul for ComplexImpl<T> {
		fn mul(self, rhs: Self) -> Self::Output {
			use math_utils::*;
			ComplexImpl(mul(&self.0, &rhs.0))
		}
	}
	impl<T: RealField> Div for ComplexImpl<T> {
		fn div(self, rhs: Self) -> Self::Output {
			use math_utils::*;
			ComplexImpl(div(&self.0, &rhs.0))
		}
	}
});
impl_assign_op!({
	impl<T: RealField> AddAssign for ComplexImpl<T> {
		fn add_assign(&mut self, rhs: Self) {
			use math_utils::*;
			*self = ComplexImpl(add(&self.0, &rhs.0));
		}
	}
	impl<T: RealField> SubAssign for ComplexImpl<T> {
		fn sub_assign(&mut self, rhs: Self) {
			use math_utils::*;
			*self = ComplexImpl(sub(&self.0, &rhs.0));
		}
	}
	impl<T: RealField> MulAssign for ComplexImpl<T> {
		fn mul_assign(&mut self, rhs: Self) {
			use math_utils::*;
			*self = ComplexImpl(mul(&self.0, &rhs.0));
		}
	}
	impl<T: RealField> DivAssign for ComplexImpl<T> {
		fn div_assign(&mut self, rhs: Self) {
			use math_utils::*;
			*self = ComplexImpl(div(&self.0, &rhs.0));
		}
	}
});
...
impl ComplexField for ComplexImpl<f32> {
	...
	fn abs1_impl(value: &Self) -> Self::Real {
		use crate::ext::*;
		value.0.re.abs1() + value.0.im.abs1()
	}

	#[inline]
	fn abs2_impl(value: &Self) -> Self::Real {
		use crate::ext::*;
		value.0.re.abs2() + value.0.im.abs2()
	}
	...
	fn mul_pow2_impl(lhs: &Self, rhs: &Self::Real) -> Self {
		use crate::ext::*;
		Complex {
			re: lhs.0.re.mul_pow2(rhs),
			im: lhs.0.im.mul_pow2(rhs),
		}
		.into()
	}
	...
	#[inline]
	fn is_finite_impl(value: &Self) -> bool {
		value.0.re.is_finite() && value.0.im.is_finite()
	}
	...
	fn simd_abs1<S: Simd>(
		...
		if const {
			core::mem::size_of::<S::c32s>() == core::mem::size_of::<S::f32s>()
		} {
			bytemuck::cast(ctx.abs_f32s(bytemuck::cast(value)))
		} else if const {
			core::mem::size_of::<S::c32s>()
	...
	fn simd_mul_real<S: Simd>(
		...
		if const {
			...
			bytemuck::cast(
				ctx.mul_f32s(bytemuck::cast(lhs), bytemuck::cast(real_rhs)),
			)
		} else if const {
			core::mem::size_of::<S::c32s>()
				== core::mem::size_of::<Complex<f32>>()
	...
	fn simd_abs2<S: Simd>(
		...
		if const {
			...
			bytemuck::cast(
				ctx.mul_f32s(bytemuck::cast(value), bytemuck::cast(value)),
			)
		} else if const {
			core::mem::size_of::<S::c32s>()
				== core::mem::size_of::<Complex<f32>>()
	...
	fn simd_less_than<S: Simd>(
		...
		if const {
			...
			ctx.less_than_f32s(
				bytemuck::cast(real_lhs),
				bytemuck::cast(real_rhs),
			)
		} else if const {
			core::mem::size_of::<S::c32s>()
				== core::mem::size_of::<Complex<f32>>()
	...
	fn simd_greater_than_or_equal<S: Simd>(
		...
		if const {
			...
			ctx.greater_than_or_equal_f32s(
				bytemuck::cast(real_lhs),
				bytemuck::cast(real_rhs),
			)
		} else if const {
...
impl ComplexField for ComplexImpl<f64> {
	...
	fn simd_abs1<S: Simd>(
		...
		if const {
			core::mem::size_of::<S::c64s>() == core::mem::size_of::<S::f64s>()
		} {
			bytemuck::cast(ctx.abs_f64s(bytemuck::cast(value)))
		} else if const {
			core::mem::size_of::<S::c64s>()
				== core::mem::size_of::<Complex<f64>>()
		} {
	...
	fn simd_mul_real<S: Simd>(
		...
		if const {
			...
			bytemuck::cast(
				ctx.mul_f64s(bytemuck::cast(lhs), bytemuck::cast(real_rhs)),
			)
		} else if const {
			core::mem::size_of::<S::c64s>()
				== core::mem::size_of::<Complex<f64>>()
	...
	fn simd_abs2<S: Simd>(
		...
		if const {
			...
			bytemuck::cast(
				ctx.mul_f64s(bytemuck::cast(value), bytemuck::cast(value)),
			)
		} else if const {
			core::mem::size_of::<S::c64s>()
				== core::mem::size_of::<Complex<f64>>()
	...
	fn simd_greater_than_or_equal<S: Simd>(
		...
		if const {
			...
			ctx.greater_than_or_equal_f64s(
				bytemuck::cast(real_lhs),
				bytemuck::cast(real_rhs),
			)
		} else if const {
...
impl ComplexField for fx128 {
	...
	fn simd_select<S: Simd>(
		...
		Quad(
			ctx.select_f64s(mask, lhs.0, rhs.0),
			ctx.select_f64s(mask, lhs.1, rhs.1),
		)
	}
...
pub mod ext {
	use super::*;
	pub use super::{ComplexField, RealField};
	pub trait ComplexFieldExt: ComplexField {
		#[inline(always)]
		#[must_use]
		fn nbits() -> usize {
			Self::Real::nbits_impl()
		}
		#[inline(always)]
		#[must_use]
		fn zero() -> Self {
		...
		fn as_real(&self) -> Self {
			Self::from_real_impl(&Self::real_part_impl(self))
		}
		#[inline(always)]
		#[must_use]
		fn real(&self) -> Self::Real {
			Self::real_part_impl(self)
		}
		#[inline(always)]
		#[must_use]
		fn imag(&self) -> Self::Real {
			Self::imag_part_impl(self)
		}
		#[inline(always)]
		#[must_use]
		fn copy(&self) -> Self {
		...
		fn mul_real(&self, rhs: impl ByRef<Self::Real>) -> Self {
			Self::mul_real_impl(self, rhs.by_ref())
		}
		#[inline(always)]
		#[must_use]
		...
		fn absmax(&self) -> Self::Real {
			if const { Self::IS_REAL } {
				Self::abs1_impl(self)
			} else {
				&Self::Real::abs1_impl(&real(self))
					+ &Self::Real::abs1_impl(&imag(self))
			}
		}
		#[inline(always)]
		#[must_use]
		...
		#[must_use]
		fn is_nan(&self) -> bool {
			Self::is_nan_impl(self)
		}
		#[inline(always)]
		#[must_use]
		fn is_finite(&self) -> bool {
			Self::is_finite_impl(self)
		}
		#[inline(always)]
		#[must_use]
		fn sqrt(&self) -> Self {
		...
		#[must_use]
		fn recip(&self) -> Self {
			Self::recip_impl(self)
		}
		#[inline(always)]
		#[must_use]
		fn from_f64(value: f64) -> Self {
			Self::from_f64_impl(value)
		}
	}
